   <%@ include file="header.jsp" %> 
   		 ...
   		 <br/><br/><br/><br/><br/>		   	
 <p align="center" style="color: #00008B;font-size: 20px;font-weight:bold;">Privacy Policy</p>
<div class="thumbnail" >
...
Our Website links to other websites that may collect personally identifiable information about you. thelightswagon.in is not responsible for the privacy practices or the content of those linked websites.
...
If you want to remove your contact information from all thelightswagon.in lists and newsletters, please visit unsubscribe

<b>7. Advertisements on thelightswagon.in</b>
